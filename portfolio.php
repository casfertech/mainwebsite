                ...
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            ...
                            <p>Creative side of CasFer Technologies</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <ul class="portfolio-filter text-center">
                    ...
                    <li><a class="btn btn-default" href="#" data-filter=".Flagship">Flagship</a></li>
                ...
                <div class="portfolio-items">
                    <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item Flagship casestudies">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb">
                                    <img src="images/portfolio/freightrates.jpg" class="img-responsive" alt="">
                                </div>
                                <div class="portfolio-view">
                                    <ul class="nav nav-pills">
                                        <li><a href="freightrates.php"><i class="fa fa-link"></i></a></li>
                                        <li><a href="images/portfolio/freightrates.jpg" data-lightbox="example-set"><i class="fa fa-eye"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item desktop">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item opensource">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item Flagship">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 portfolio-item casestudies">
                        <div class="portfolio-wrapper">
                            <div class="portfolio-single">
                                <div class="portfolio-thumb">
                                    <img src="images/portfolio/16.jpg" class="img-responsive" alt="">
