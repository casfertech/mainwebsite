...
<!--                             <li><a href="#"><i class="fa fa-clock-o"></i>September, 2016</a></li> -->
                    ...
                    <div class="project-info overflow">
                        <h3>Project Info</h3>
                        <p>A venture based in India in the process of simplifying and revolutionizing supply chain processes for our customers. We have expertise in product sourcing from India for small and medium scale overseas firms, a few of our core activities include</p>
                        <ul class="elements">
                            <li><i class="fa fa-angle-right"></i> Supplier Search.</li>
                            <li><i class="fa fa-angle-right"></i>RFQ bids and analyze quotations for best prices and as per requested standards.</li>
                            <li><i class="fa fa-angle-right"></i>Supplier feasibility and assessment.</li>
                        <p> We would be glad to assist you in sourcing top quality and price competitive components from trusted suppliers in India.</p>
                        </ul>
                    </div>
